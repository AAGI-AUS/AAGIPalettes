...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("AAGI-Org-AU-Public/AAGIPalettes", fork = TRUE)`.
...
- We use [Air](https://posit-dev.github.io/air/formatter.html) to format
  our code.
...
[Contributor Code of
Conduct](https://AAGI-AUS.github.io/CODE_OF_CONDUCT.md). By contributing
