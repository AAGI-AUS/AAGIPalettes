...
{AAGIPalettes} is available through the
...
{AAGIPalettes} provides limited functionality for viewing and working
...
![A plot of the official AAGI
colours.](reference/figures/README-plot_official_colours-1.png)

A plot of the official AAGI colours.
...
![A plot of the AAGI BuOr palette with 9
stops.](reference/figures/README-plot_BuOR-1.png)

A plot of the AAGI BuOr palette with 9 stops.
...
![A plot demonstrating the colour interpolation functionality of the
package.](reference/figures/README-interpolate_colours-1.png)
...
[Contributor Code of
Conduct](https://AAGI-AUS.github.io/AAGIPalettes/CODE_OF_CONDUCT.html).
